    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{ route('home') }}" target="_blank" class="nav-link">@lang('Show blog')</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('indexPosts')}}" class="nav-link ">
                                    <i class="far fa-circle"></i>
                                    <p>All Posts</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('publishedPosts')}}" class="nav-link ">
                                    <i class="far fa-circle"></i>
                                    <p>Published Posts</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('draftsPosts')}}" class="nav-link ">
                                    <i class="far fa-circle"></i>
                                    <p>Drafts Posts</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('scheduledPosts')}}" class="nav-link ">
                                    <i class="far fa-circle"></i>
                                    <p>Scheduled Posts</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('archivedPosts')}}" class="nav-link ">
                                    <i class="far fa-circle"></i>
                                    <p>Archived Posts</p>
                                </a>
                            </li>
